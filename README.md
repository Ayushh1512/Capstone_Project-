# Capstone_Project
This capstone project is a complete end-to-end data science workflow that scrapes 1,000 books from the web, cleans and analyzes the data, builds ML classification models to predict high-rated books, and delivers findings through an interactive Plotly Dash dashboard.
...
● Scrape 1,000+ book records from books.toscrape.com, capturing 10 meaningful fields per record.

● Clean and preprocess the raw dataset, handling missing values and engineering new features.

● Conduct Exploratory Data Analysis (EDA) to uncover statistical and visual insights.

● Build and evaluate multiple classification models to predict high-rated books.

● Deliver an interactive Plotly Dash dashboard communicating key insights and model outcomes.


# Tasks:

- Web Scraping Script- A reproducible Python script or notebook that extracts data from a chosen website or API.
...
- Interactive Dashboard- A dashboard (using Power BI, Tableau, or Python libraries like Streamlit/Plotly Dash) presenting key insights, trends, and model outcomes. Include at least two KPIs, trend charts, AI and custom visuals and important reporting features like RLS, sync slicer, bookmark, drill through, etc.
  
- Final Report / Presentation- Summarizing methodology, insights, model results, and recommendations.
